...
const ListNews: React.FC = () => {
  ...
  const loadItems = () => {
    ...
    newsDbService.getNewsAndEvents()
      .then((data) => {
        // Filter only news type
        const newsOnly = data.filter(item => item.type === 'news');
        setItems(newsOnly);
        setLoading(false);
      })
      .catch((err) => {
        ...
        <div className={styles.centeredPage}>
          <div className={styles.glassCard}>
            ...
            <p className={styles.cardText}>
              Please sign in to manage news articles. Authenticated actions are secured by database policy.
            </p>
