...
CREATE TABLE IF NOT EXISTS news_events (
    ...
    important_dates JSONB DEFAULT '[]'::jsonb, -- list of dates (date_title, date, meta)
...
INSERT INTO news_events (
    ...
    rich_content, related_news_slugs, is_demo, important_dates, 
...
This breakthrough brings us one step closer to commissioning the 28.10 MW run-of-the-river project, which will feed clean energy into Nepal''s national grid, contributing to the country''s sustainable development and energy security goals.', 
    ...
    '[]'::jsonb, 
    false, 
    '[{"date_title": "Project Start Date", "date": "2024-04-01", "meta": {}}, {"date_title": "Breakthrough Date", "date": "2026-06-07", "meta": {}}]'::jsonb, 
