        ...
        <>
            ...
            <main className={styles['main-content']}>
                ...
                <div className={styles['hero-section']}>
                    {service.image && <img src={service.image} alt={service.title} className={styles['hero-bg']} />}
                        ...
                        <article className={styles['detail-content']}>
                            ...
                            <section className={styles['section-block']}>
                                ...
                                <div className={styles['capabilities-grid']}>
                                    {service.capabilities && service.capabilities.map((cap: string, index: number) => (
                            ...
                            <section className={styles['section-block']}>
                                ...
                                <div className={styles['tech-stack-flex']}>
                                    {service.techStack && service.techStack.map((tech: string, index: number) => (
                            ...
                            <section className={styles['section-block']}>
                                ...
                                <div className={styles['process-timeline']}>
                                    {service.process && service.process.map((step: string, index: number) => (
