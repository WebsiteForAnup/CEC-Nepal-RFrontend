...
const Navbar: React.FC = () => {
  ...
  const [logoFirst, logoSecond] = (siteConfig.meta.shortName || 'CEC Nepal').split(' ');
    ...
    <>
      ...
      <div className={styles.topBar}>
        <div className={styles.topContainer}>
          ...
          <a href="#!" onClick={(e) => { e.preventDefault(); setShowBookingForm(true); }} className={styles.callButton}>
        ...
        <div className={styles.container}>
          <div className={styles.navFlex}>
            ...
            <ul className={styles.navLinks}>
              ...
              <li><Link to="/careers" onClick={() => setMobileMenuOpen(false)}>Careers</Link></li>
              ...
              >
                <a href="#updates" onClick={(e) => e.preventDefault()}>Updates</a>
