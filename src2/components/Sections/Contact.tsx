...
const Contact: React.FC<ContactProps> = ({ company = {} }) => {
  const [formState, setFormState] = useState<FormState>({ name: '', email: '', message: '', phone: '', subject: '' });
  ...
  const mapCoordinates = React.useMemo<any[]>(() => {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.contactWrapper}>
          ...
          <div className={styles.contactForm}>
            ...
            {statusMessage.text && (
              <div className={`${styles.message} ${statusMessage.type ? styles[statusMessage.type] : ''}`}>
